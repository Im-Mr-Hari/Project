...
const Footer = () => {
    ...
    const checkMail = (e) => {
        const valMail = e.target.value;

        if (valMail === "") {
            setErrorMail(`Email is can't left blank!`);
        }
    ...
    return (
        <footer>
            <div className="container_footer">
                <div className="footer-sectionAbove">
                    ...
                    <div style={{ width: "50%" }} className="signUp-insurance">
                        ...
                        <form action="">
                            <div className="box-register-insurance">
                                <input onChange={checkMail} type="text" placeholder="Enter your email" />
                                <button onClick={submitMail} style={{ marginBottom: "5px" }} className="btn-register-insurance">Register</button>
                                <br />
                                <span style={{ color: "#bd1919" }}>{errorMail}</span>
                            </div>
                        </form>
                    </div>
                </div>
